...
%global gopath          %(go env | grep GOROOT| cut -d= -f2 | awk 'BEGIN{FS="\\""}{print $2}')
%global homedir         /home/coredns

#Name:           golang-%{provider}-%{project}-%{repo}
Name:           iwg-%{repo}
Version:        __version__
Release:        %{shortcommit}%{?dist}
Summary:        Flexible DNS server written by golang
# Detected licences
# - Unknown at 'LICENSE'
License:        MIT
URL:            https://%{provider_prefix}
#Source0:        https://%{provider_prefix}/archive/%{commit}/%{repo}-%{shortcommit}.tar.gz
Source0:        https://%{provider_prefix}/archive/%{commit}/%{repo}.tar.gz
...
%license LICENSE
%doc CONTRIBUTING.md middleware.md README.md
